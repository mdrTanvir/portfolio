  ...
  >
    ...
    <div v-if="PROJECTS.length">
      ...
      <div class="relative flex flex-col items-center justify-center w-full max-h-screen pt-10">
        <div>
          <div v-if="!all && projects.length > perPage" class=" my-8">
            <UiAnimate :distance="40">
          ...
          <UiAnimate :distance="40">
            <div class="flex items-center justify-center h-[80px] md:h-[160px] relative">
              <div class="rotate-90 py-6">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 38 15" class="w-20 md:w-40 h-auto">
                  <path
