<template>
  ...
  >
    ...
    <div v-if="PROJECTS.length">
      ...
      <div class="relative flex flex-col items-center justify-center w-full max-h-screen" style="height: 70vh">
        <div>
          ...
          <div class="flex items-center justify-center h-full max-h-96 relative">
            <div class="rotate-90 py-10">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 38 15" class="w-56 h-auto">
                <path
                    ...
                    class="fill-gray-300 dark:fill-gray-900"
                />
              </svg>
            </div>
          </div>
